...
pub(crate) async fn find_book_by_id(db: SqlitePool, book_id: i32) -> Result<Option<Book>, sqlx::Error> {
...
pub(crate) async fn insert_book(db: SqlitePool, title: String) -> Result<SqliteQueryResult, sqlx::Error> {
